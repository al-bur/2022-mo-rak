...
const getPolls = (groupCode: GroupInterface['code']): Promise<getPollsResponse> =>
  axios.get(`/${groupCode}/polls`).then((res) => res.data);

const getPoll = (
  pollCode: PollInterface['code'],
  groupCode: GroupInterface['code']
): Promise<getPollResponse> =>
  axios.get(`/${groupCode}/polls/${pollCode}`).then(({ data }) => data);
...
const getPollResult = (
  ...
  axios.get(`/${groupCode}/polls/${pollCode}/result`).then(({ data }) => data);
